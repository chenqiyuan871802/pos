...
(function(layui, window, factory) {
	...
	let v = '4.0.0.0910',
		...
		quickBtns = [
			{icon: 'xm-iconfont icon-quanxuan', name: '全部', click: function(id, cm){
				cm.selectAll(id, true, true);
			}},
			{icon: 'xm-iconfont icon-qingkong', name: 'クリア', click: function(id, cm){
				cm.removeAll(id, true, true);
			}},
			{icon: 'xm-iconfont icon-fanxuan', name: '逆選択', click: function(id, cm){
