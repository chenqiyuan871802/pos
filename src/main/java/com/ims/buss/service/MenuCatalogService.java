...
import com.ims.buss.mapper.MenuCatalogMapper;
 ...
 */
@Service
public class MenuCatalogService extends ServiceImpl<MenuCatalogMapper, MenuCatalog>  {
     
   
     /**
	 * 根据Dto查询并返回数据持久化对象集合
	 * 
	 * @return List<MenuCatalog>
	 */
	public List<MenuCatalog> list(Dto pDto){
	 ...
	 * 
	 * @return Page<MenuCatalog>
	 */
	public Page<MenuCatalog> listPage(Dto pDto){
	    Query<MenuCatalog> query=new Query<MenuCatalog>(pDto);
	 ...
	 * @return List<MenuCatalog>
	 */
	public List<MenuCatalog> like(Dto pDto){
	 ...
	 * @return Page<MenuCatalog>
	 */
	public Page<MenuCatalog> likePage(Dto pDto){
	    Query<MenuCatalog> query=new Query<MenuCatalog>(pDto);
