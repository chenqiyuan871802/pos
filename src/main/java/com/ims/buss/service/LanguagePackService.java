...
import com.ims.buss.mapper.LanguagePackMapper;
...
public class LanguagePackService extends ServiceImpl<LanguagePackMapper, LanguagePack>  {
	 ...
	 */
	public List<LanguagePack> list(Dto pDto){
	 ...
	 * 
	 * @return Page<LanguagePack>
	 */
	public Page<LanguagePack> listPage(Dto pDto){
	    Query<LanguagePack> query=new Query<LanguagePack>(pDto);
	 ...
	 * @return List<LanguagePack>
	 */
	public List<LanguagePack> like(Dto pDto){
	 ...
	 * @return Page<LanguagePack>
	 */
	public Page<LanguagePack> likePage(Dto pDto){
	    Query<LanguagePack> query=new Query<LanguagePack>(pDto);
